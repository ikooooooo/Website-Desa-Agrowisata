...
$kriteria = [
    "Bagaimana kondisi lahan pertanian di desa?",
    "Apakah lahan yang tersedia cukup untuk pengembangan agrowisata?",
    "Bagaimana kondisi akses jalan menuju lahan pertanian/agrowisata?",
    "Apakah Desa Mampu mengelola perekomonian desa serta aset agrowisata?",
    "Apakah Desa memiliki Sumber pendanaan pengembangan agrowisata?"
];
...
<head>
    ...
    <main class="perhitungan">
        <h2>Identifikasi Desa Agrowisata</h2>
        <p>Pililah jawaban sesuai dengan pendapat anda untuk setiap kriteria (1-5, 1 = sangat kurang, 2 = kurang, 3 = cukup, 4 = baik, 5 = sangat baik)
